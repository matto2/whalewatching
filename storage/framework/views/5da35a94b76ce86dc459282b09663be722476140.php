				...
				<div id="nav" class="top-bar">
					<nav class="top-bar-section">
						<ul class="dropdown vertical large-horizontal menu no-js nav-bar" data-responsive-menu="drilldown large-dropdown">
							...
							<li><a href="/great-white-shark-encounters-santa-cruz" title="Marine Wildlife Encounters">Marine Wildlife Encounters</a></li>
			...
			<div class="columns">
				<div class="small-12 medium-2 large-3 xlarge-2 columns" id="left">
					<ul class="menu vertical">
						...
						<?php if( Auth::check() ): ?>
							<li><a class="userLogoutLink" href="<?php echo e(route( 'user.logout' )); ?>">Logout - <?php echo e(auth()->user()->first_name); ?></a></li>
						<?php else: ?>
				...
				<div class="small-12 medium-7 large-5 xlarge-6 columns">
					<div class="columns y show-for-small-only">
						<p class="mb0"><a class="button expanded" <?php echo $__env->make('linkhref', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>>Book online Now</a></p>
					</div>
					<div class="columns show-for-small-only">
						<p class="c">Now! Marine Wildlife Encounters!</p>
						<p class="c"><a href="/great-white-shark-encounters-santa-cruz" title="Marine Wildlife Encounters">Marine Wildlife Encounters</a></p>
						<hr>
					</div>
			...
			<!-- End Individual Pages -->
				...
				<div class="small-12 medium-5 large-4 xlarge-4 columns" id="right">
					<div class="columns shark1">
						<h4><a href="/great-white-shark-encounters-santa-cruz" title="Marine Wildlife Encounters "><span class="hide-for-small-only">2-Hour </span>Marine Wildlife Encounters</a></h4>
						<p><img src="/images/shark14.jpg" alt="Great White Shark Encounters in Monterey Bay"></p>
						<p class="c"><a href="/great-white-shark-encounters-santa-cruz" title="Marine Wildlife Encounters">Click Here For Marine Wildlife Tours</a></p>
						<hr>
					</div>
					<div class="columns y"> <!--  hide-for-small-only ** IF YOU WANT TO HIDE THIS UPON SMALL SCREENS -->
						<a class="button expanded" <?php echo $__env->make('linkhref', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>>Book online Now</a>
					</div>
					<div class="columns">
