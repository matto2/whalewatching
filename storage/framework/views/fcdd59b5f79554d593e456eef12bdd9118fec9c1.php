...
<title><?php echo e(pageTitle('About Us')); ?></title>
...
<?php $__env->startSection('content'); ?>
					...
					<p>Stagnaro Charter Boats proudly presents the charter boat Velocity. Built by Yank Marine, Inc., in Tuckahoe, New Jersey, she was completed in California in 2005 and complies with all the latest safety standards. Velocity is 60′ long and is certified by the U.S. Coast Guard to carry 66 passengers. She is the only charter boat on Monterey Bay to feature a full service galley and serves both breakfast and lunch items as well as your favorite beverage. Due to Covid-19 the Galley is limited to snacks and cold beverages.<!--
