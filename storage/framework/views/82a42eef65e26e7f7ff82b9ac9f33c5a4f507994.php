...
<body>
	<table width="600" cellpadding="0" cellspacing="0">
		<tr><td><img src="<?php echo e(config( 'app.url')); ?>/images/logoemail.jpg" alt="Arts Logo" style="width:600px;height:auto;"></td></tr>
		<tr><td><h1>Welcome to SCWW Admin!</h1></td></tr>
		<tr>
			<td>
				<p>Hello, <?php echo e($user->first_name); ?>!</p>
				<p>Thank you for creating an account on SCWW! Your email address is <strong><?php echo e($user['email']); ?></strong>.</p>
			</td>
		</tr>
