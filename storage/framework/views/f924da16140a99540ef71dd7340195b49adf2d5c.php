...
<body>
	<table width="600" cellpadding="0" cellspacing="0" style="border:1px solid #7599b3; padding:10px;">
		...
		<tr><th>Your Password Was Changed</th></tr>
		<tr>
			<td style="">
				<p>Hello, <?php echo e($user['first_name']); ?>!</p>
				<p>We just processed a password change on your account.</p>
				<p>If you did not initiate this password change, please click below to change your password.</p>
