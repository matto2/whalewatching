<?php
	...
	use App\Http\Controllers\Controller;
 	use App\Http\Requests\Admin\User\Address\UserAdminAddressAddRequest;
 	use App\Http\Requests\Admin\User\Address\UserAdminAddressEditRequest;
	...
	class AddressController extends Controller {
		...
		public function getAdd( Request $request, $id ) {
			return view( 'admin.user.address.add', [ 'user' => User::find( $id ), 'states' => State::orderBy( 'name', 'asc' )->get() ] );
		}
