...
@section('head')
	<title>{{ pageTitle('Add a User') }}</title>
@stop
...
@section('content')
	...
	<form id="addUserForm" method="post" action="{{ route('admin.user.add' ) }}" data-form-ajax autocomplete="off" data-form-ajax-clear data-form-wait-title="Adding user...">
		<div class="row">
			<div class="small-12 columns">
				...
				<div class="secondary callout">		
					...
					<div class="controls">		
						...
						@if ( setting( 'userPasswordNoExpireEnable' ) )
							@if ( setting( 'userPasswordAgeMax' ) > 0 )
