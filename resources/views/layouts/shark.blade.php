...
<head>
	...
	@yield('stylesheets')
	<!-- Google Analytics updated 04/10/17 -->
	<script>
		(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
		(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
		m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
		})(window,document,'script','https://www.google-analytics.com/analytics.js','ga');
		ga('create', 'UA-70358908-15', 'auto');
		ga('send', 'pageview');
	</script>	
</head>
<body id="tophead">
				...
				<div id="nav" class="top-bar">
					<nav class="top-bar-section">
						<ul class="dropdown vertical large-horizontal menu no-js nav-bar" data-responsive-menu="drilldown large-dropdown">
							...
							<li><a href="/recent-sightings" title="Santa Cruz Whale Watching">Recent Sightings</a></li>
							...
							<li><a href="/marine-wildlife-encounters-santa-cruz" title="Marine Wildlife Encounters">Marine Wildlife Tours</a></li>
							...
							<li class="h"><a href="/videos" title="Santa Cruz Whale Watching">Videos</a></li>
			...
			<div class="columns">
				<div class="small-12 medium-2 large-3 xlarge-2 columns" id="left">
					<ul class="menu vertical">
						...
						<li><a href="/videos" title="Santa Cruz Whale Watching">Videos</a></li>
						...
						@if ( Auth::check() )
							<li><a class="userLogoutLink" href="{{ route( 'user.logout' ) }}">Logout - {{ auth()->user()->first_name }}</a></li>
						@else
				...
				<div class="small-12 medium-7 large-5 xlarge-6 columns">
					<div class="columns y show-for-small-only">
						<a class="button expanded" @include('linkhref')>Book online Now</a>
					</div>
	...
	@if ( Session::has( 'globalFlashAlerts' ) && is_array( Session::get( 'globalFlashAlerts' ) ) )
		@foreach ( Session::get( 'globalFlashAlerts' ) as $alert )
			@if ( @$alert['dismissable'] )
				<div class="{{ $alert['type'] }} callout" data-closable>
					{!! @$alert['message'] !!}
					<button class="close-button" data-close aria-label="Dismiss alert">&times;</button>
				</div>
			@else
				<div class="{{ $alert['type'] }} callout">
					{!! @$alert['message'] !!}
				</div>
			@endif
		@endforeach
	@endif
			...
			<!-- End Individual Pages -->
				...
				<div class="small-12 medium-5 large-4 xlarge-4 columns" id="right">
					<div class="columns shark">
					    <!--
						<p><a href="/great-white-shark-encounters-santa-cruz" title="Great White Shark Encounters"><img src="/images/shark13.jpg" alt="Great White Shark Encounters in Monterey Bay"></a></p> -->
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p class="c"><a href="/marine-wildlife-encounters-santa-cruz" title="Marine Wildlife Shark Encounters">Click Here</a></p>
					</div>
					...
					<div class="columns">
						...
						<h3>Social</h3>
						<p class="social"><a href="https://www.facebook.com/santacruzwhalewatching/" target="_blank"><img src="/images/f67.jpg" alt="Facebook Page"></a> <!--
										  ...
										  <a href="https://weather.com/weather/tenday/l/USCA1020:1:US" target="_blank"><img src="/images/w67.jpg" alt="Santa Cruz Weather"></a></p>
					</div>
					...
					<div id="trip" class="columns callout">
						...
						<div>
							<a href="https://www.tripadvisor.com/Attraction_Review-g33048-d754009-Reviews-Stagnaro_Sport_Fishing_Charters_Whale_Watching_Cruises-Santa_Cruz_California.html/" title="" target="_blank">Stagnaro Sport Fishing Charters &amp; Whale Watching Cruises rated "excellent" by <span class="r">887</span> travelers</a><br />
