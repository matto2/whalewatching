	...
	<table width="600" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td style="">
				...
				<p>This password reset link will expire in 24 hours. If you did not request this password reset, simply log on to your account to delete this link. This reset code has only been sent to {{ $user['email'] }}.</p>
			</td>
		</tr>
	</table>
</body>
