	...
	<table width="600" cellpadding="0" cellspacing="0" style="border:1px solid #7599b3; padding:10px;">
		...
		<tr>
			<td style="">
				...
				<p>We just processed a change to your e-mail address. Your old e-mail address of '{{ $user->email }}' was changed to '{{ $newEmail }}'. This message has been sent to both email accounts.</p>
				<p>If you did not initiate this e-mail address change, please click below to change your e-mail address.</p>
